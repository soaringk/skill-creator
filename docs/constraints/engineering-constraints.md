...
- Maintain the existing context-infrastructure candidate folder model unless there is a concrete security or usability reason to migrate.

## Compatibility

- This is a developing project with no backward-compatibility guarantee yet.
- Do preserve compatibility with the existing candidate file model: `index.md`, `draft.md`, `proposal.md`, `materials/text`, `materials/audio`, and `materials/transcripts`.
...
- For normal user UX, hide pipeline internals behind clear flows: collect material, review draft, review proposal, approve/publish, use skill.
